                        ...
                        <div class="p-8">
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <x-text-input id="data_evento" name="data_evento" type="datetime-local" class="mt-1 block w-full border-slate-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" :value="old('data_evento')" required />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="data_inicio_inscricoes" name="data_inicio_inscricoes" type="datetime-local" class="mt-1 block w-full border-slate-300 rounded-lg focus:ring-green-500 focus:border-green-500" :value="old('data_inicio_inscricoes')" required />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="data_fim_inscricoes" name="data_fim_inscricoes" type="datetime-local" class="mt-1 block w-full border-slate-300 rounded-lg focus:ring-red-500 focus:border-red-500" :value="old('data_fim_inscricoes')" required />
