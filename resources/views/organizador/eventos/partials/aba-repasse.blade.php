<div class="space-y-6">
    ...
    {{-- 2. Histórico de Repasses e Formulário de Dados Bancários --}}
    <div class="grid grid-cols-1 lg:grid-cols-5 gap-6">
        
        {{-- Coluna do Histórico de Repasses --}}
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase">Comprovante</th>
                        </tr>
                    </thead>
                        ...
                        @forelse ($repasses as $repasse)
                            <tr>
                                ...
                                <td class="px-4 py-3 text-sm">
                                    <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full {{ $repasse->status === 'efetuado' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800' }}">
        ...
        {{-- Coluna do Formulário de Dados para Repasse --}}
        <div class="lg:col-span-2 bg-white overflow-hidden shadow-sm rounded-lg p-6">
            <form method="POST" action="{{ route('organizador.financeiro.update') }}" class="space-y-6">
                @csrf
                @method('PATCH')
